...
This project focuses on sales performance analysis for Kraken Koffee’s Florida region.
The dashboard examines product trends, revenue behavior throughout the day, and provides a mid-year sales performance overview.
The goal of the report is to support operational and strategic decisions by identifying peak sales periods and top-performing products.

**Key insights explored:**
- Revenue trends over time
- Hourly sales patterns
- Product performance
- Mid-year sales overview

Dataset: Internal sales dataset          
...
*Project folder:* `PowerBI/Azure_SQL_PowerBI_Dashboard`
...
*Project folder:* `Excel/BIOPHARMA_Financial Reconciliation`
...
- Parsing inconsistent dates, currencies, and categorical values with SQL
- Deduplicating records with unequal completeness using window functions
- Declarative pipeline design with automatic dependency resolution
- Data quality reporting alongside the analytics output
Dataset: Synthetic ATP match data, generated with intentional data quality issues                                   
*Project folder:* `Databricks/ATP_Match_Analytics`
